...
export class Game {
  ...
  collectDiagnostics() {
    ...
    const diagnostics = {
      ...
      proxyBlendTownItems: renderBudgetStats.proxyBlendItems ?? 0,
      fadedProxyTownItems: renderBudgetStats.fadedProxyItems ?? 0,
    ...
    Object.assign(this.diagnosticsElement.dataset, {
      ...
      proxyBlendTownItems: String(diagnostics.proxyBlendTownItems),
      fadedProxyTownItems: String(diagnostics.fadedProxyTownItems),
  ...
  updateDebugOverlay(diagnostics) {
    ...
    this.diagnosticsElement.innerHTML = `
      ...
      ${this.renderDebugSection('Town', [
        ...
        ['LOD Blend / Fade', `${formatDebugNumber(diagnostics.proxyBlendTownItems)} / ${formatDebugNumber(diagnostics.fadedProxyTownItems)}`],
